# Measurement data – 25 F

This folder contains measurement data, results and related files for supercapacitor discharge tests using 25 F units (DUT set). Only preview/example files that are safe to share publicly should be placed here. Do not upload full raw datasets or sensitive files.

## Contents

- **[Discharge Curves Overview](measurments.md)** - Visual gallery of all 25 F discharge measurement curves organized by manufacturer
- **Images** - PNG files of discharge curve plots for all tested 25 F devices
