...
**Dataset 2 (25 F Multi-Manufacturer Set):** Eighteen 25 F supercapacitors representing six manufacturers (Eaton, Kyocera/KEMET, Maxwell, Sech, Vishay, and Würth Elektronik), with three devices per manufacturer from the same batch. All devices are rated at 3.0 V except Würth Elektronik (2.7 V).
...
- ESR current (Class 2 / C Class 3): 0.60 A
- Method 1B high-current: 3.41 A (95% efficiency criterion)
...
All DUTs were charged according to IEC specifications with 95% charge efficiency. Method 1B high-current discharges were excluded from the multi-manufacturer set to ensure comparability, as these currents vary based on each device's rated ESR.
...
| Maxwell | 2 | 3.0 | 25 | 17 | 16.0 | 25.5 |
| Sech | 2 | 3.0 | 25 | 25 | 16.0 | 25.0 |
| Würth Elektronik | 2 | 2.7 | 25 | 25 | 16.0 | 25.0 |

*Note: Actual measured parameters may differ from datasheet values due to tolerances and test condition variations.*
