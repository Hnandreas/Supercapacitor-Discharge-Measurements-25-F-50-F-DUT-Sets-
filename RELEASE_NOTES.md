# Release v0.1.0V — Preview for review (supplementary material)

Version: v0.1.0V (preview)
Purpose: This release provides supplementary preview material for reviewers and readers in support of the planned manuscript. It contains short descriptions, example images and minimal example data necessary to illustrate the experimental setup and representative results.

Contents (example)
- README files for 25 F and 50 F measurement folders
- images/: preview figures and photos
